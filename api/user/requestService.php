...
$sql = "INSERT INTO `service_request` (`service_no`,`service_name`,`service_amount`,`service_date`,`customer_name`,`customer_mobile`,`customer_pan`,`customer_aadhar`,`customer_address`,`payment_mode`,`amount_paid`,`amount_due`,`userkey`,`status`) VALUES ('$service_no','$service_name','$service_cost','$sell_date','$customer_name','$customer_contact','$customer_pan','$customer_aadhar','$customer_add','$payment_mode','$amount_paid','$amount_due','$user_unique','$status')";
