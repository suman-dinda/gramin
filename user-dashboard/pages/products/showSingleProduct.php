<main ng-controller="showSingleProduct">
  <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        {{showProductsTitle | uppercase}}
    ...
    <!-- Main content -->
    <section class="content" ng-init="showSingleCategoryProducts()">
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-3 product-grid" ng-repeat="prd in sigleCatData">
                  <div class="card">
                    ...
                    <!-- <section class="footer-buttons center">
                        <div class="row">
                          <div class="col-md-6 col-xs-6">
                            <button type="button" class="btn btn-primary"><i class="fa fa-shopping-cart fa-fw"></i></button>
                          </div>
